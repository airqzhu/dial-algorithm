    ...
    with open('road_link.csv') as file_object:
        ...
        for line in lines[1:]:
            ...
            try:
                ...
                link.FFTT_in_minute = float(line[11])
                link.BPR_alpha = float(line[13])
                link.BPR_beta = float(line[14])
...
if __name__=='__main__':
    ...
    distance,predecessor=DIJKSTRA(2)
   
    distance_1=s_DIJKSTRA(4)
    
    network,link_flow=DialAlgorithm()
    print(network)
    print(link_flow)
